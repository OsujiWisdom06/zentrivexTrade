      ...
      <main className="dashboard-main">
        ...
        <div className="wallet-container">
          ...
          <div className="wallet-header">
            <h2>My Wallet</h2>
            <p>Manage your cryptocurrency wallets and account balances.</p>
          </div>

          {/* Total Balance */}

          <div className="wallet-balance-card">
            <h4>Total Portfolio Balance</h4>
            <h1>$18,562.90</h1>
          ...
          <div className="wallet-security-section">
            ...
            <div className="security-card">
              ...
              <ul>
                ...
                <li>💻 Always use trusted devices to access your account.</li>

                <li>📧 Never click suspicious emails claiming to be Zentrivex Trade.</li>

                <li>🛡️ Keep your login credentials private and secure.</li>
